...
namespace lfs::training {
    ...
    class KGS : public IStrategy, public ICheckpointStateAdopter {
    public:
        static constexpr int kExploreSplits = 20;
        static constexpr int kExploreSeeds = 20;
        static constexpr float kSeedOpacity = 0.03f;
        static constexpr float kFarGrowthCap = 0.3f;
        static constexpr float kFarDecayScale = 0.25f;
        static constexpr float kFarMaskOrbits = 2.0f;
        static constexpr float kSeedDepthOrbits = 32.0f;
        static constexpr float kFarCapRatioFull = 2.0f;
        static constexpr float kFarCapRatioRich = 3.5f;
        static constexpr float kStarvEps = mrnf_strategy::kStarvEps;
        static constexpr float kStarvGamma = mrnf_strategy::kStarvGamma;
        static constexpr float kExploreStarvDose = mrnf_strategy::kExploreStarvDose;

        KGS() = delete;
        explicit KGS(lfs::core::SplatData& splat_data);

        KGS(const KGS&) = delete;
        KGS& operator=(const KGS&) = delete;
        KGS(KGS&&) = delete;
        KGS& operator=(KGS&&) = delete;
        ...
        const char* strategy_type() const override { return "kgs"; }
